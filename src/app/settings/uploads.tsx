  ...
  return (
    <div className="card-body">
      ...
      <div className="tab-content">
                ...
                <div className="form-fields">
                  ...
                  <div className="form-group mb-3">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setEditState({ ...editState, genre: e.target.value })
                      }
                    >
                  ...
                  <div className="form-group mb-3">
                    ...
                    <input
                      ...
                      value={editState.bpm || ""}
                      onChange={(e) =>
                        setEditState({ ...editState, bpm: e.target.value })
                      }
                  ...
                  <div className="form-group mb-3">
                    ...
                    <input
                      className="form-control"
                      value={
                        Array.isArray(editState.moods)
                          ? editState.moods.join(", ")
                          : editState.moods || ""
                      }
                      onChange={(e) =>
                        setEditState({
        ...
        <div
          className={`tab-pane fade ${activeTab === "licenses" ? "show active" : ""}`}
        >
          {isLoadingLicenses ? (
              ...
              <table className="table">
                ...
                <tbody>
                  {licenses.map((license) => (
                    <tr key={license.id}>
                      <td>{formatDate(license.attributes.purchaseDate)}</td>
                      <td>{license.attributes.sampleName}</td>
                      <td>
                        {
                          license.attributes.purchasedBy?.data?.attributes
                            .username
                        }
                      </td>
                      <td>
                        <button
                          ...
                          onClick={() =>
                            window.open(license.attributes.licenseUrl, "_blank")
                          }
                        >
                          ...
                          <ul className="dropdown-menu">
                            <li>
                              <button
                                ...
                                onClick={() =>
                                  window.open(
                                    license.attributes.wavUrl,
                                    "_blank"
                                  )
                                }
                                disabled={!license.attributes.wavUrl}
                              >
                                .WAV File
                              </button>
                            </li>
                            <li>
                              <button
                                ...
                                onClick={() =>
                                  window.open(
                                    license.attributes.stemsUrl,
                                    "_blank"
                                  )
                                }
                                disabled={!license.attributes.stemsUrl}
                              >
                                Stems
                              </button>
                            </li>
        ...
        <div className="delete-confirm-overlay">
          <div className="delete-confirm-modal">
            ...
            <div className="d-flex justify-content-end gap-2">
              ...
              <button className="btn btn-danger" onClick={handleDeleteSample}>
                Delete
              </button>
            </div>
          </div>
